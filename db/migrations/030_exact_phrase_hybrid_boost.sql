-- Quando a consulta contém literalmente um trecho indexado, a fonte exata
-- deve vencer candidatos semânticos genéricos. O bônus é aplicado uma vez por
-- documento e não altera o comportamento para consultas comuns.
