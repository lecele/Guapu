...
| 2A. Qualidade e velocidade | Bloqueada externamente | Cache versionado, benchmark real, bateria pós-cache e paridade Drive/manifesto aprovados; o arquivo `Teste.docx` foi detectado e enfileirado, mas o embedding falhou por `429 RESOURCE_EXHAUSTED`, com zero chunks | Repor créditos Gemini, remover `Teste.docx` manualmente e repetir o ciclo completo |
