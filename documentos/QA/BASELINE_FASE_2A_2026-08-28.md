...
- A busca híbrida foi corrigida e testada diretamente no Supabase real com três perguntas. A correção preservou as fontes esperadas, mas a latência variou de 0,25 s a 5,26 s, acima do orçamento de 3 s em pergunta ampla da Biblioteca. A busca semântica equivalente ficou entre 0,23 s e 1,04 s. A híbrida permanece desativada no caminho do aluno até haver uma versão seletiva que mantenha o orçamento.
